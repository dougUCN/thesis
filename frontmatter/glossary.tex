...
\newglossaryentry{T_fp}{
    ...
    description={Free precession period in the Ramsey method},
}
...
\newglossaryentry{gamma_n}{
    ...
    description={Neutron gryomagnetic ratio $2|\mu_\text{n}|/\hbar$},
    value={$-1.832\,471\,71(43)\times10^8\text{ s}^{-1}\text{T}^{-1}$
...
\newglossaryentry{lorentz}{
    name=\ensuremath{\Gamma_\text{L}},
    description={Relativistic Lorentz factor in the lab frame},
    type=doNotPrint,
}
...
\newglossarystyle{symbolstyle}{%
    ...
    \setlength{\glsdescwidth}{0.5\hsize} % change width of description column
}
