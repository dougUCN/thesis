...
\comment{PPM and PPM window paragraph.} For the measurements described in this paper, we varied $ |\gls*{bField} |$ for the purpose of obtaining information on the UCN spectrum.
...
On both the monitor and the drop-detector, \comment{PMTs}. The photocathode diameters of the drop-detector and monitor detector PMTs were \qty{76.2}{\mm} and \qty{28.6}{\mm}, respectively.
