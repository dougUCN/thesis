...
\end{align}
%
Similarly, the function \mintinline[bgcolor=white, style=sas, fontsize=\small]{cpp}{vector<double> neutron::derivs} describes spin in a linear Rabi sequence. Combining Eqs.~(\ref{eq:rabi_linear_1})--(\ref{eq:rabi_linear_2}) with (\ref{eq:a0_Re_Im})--(\ref{eq:b0_Re_Im}), giving
%
\begin{align}
