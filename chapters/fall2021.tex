...
In summary, the fact that the lower (new) switcher transported a larger number of UCN than the upper (previously characterized) switcher was a validation of UCN transport.
