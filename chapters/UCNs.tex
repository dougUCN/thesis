...
\end{gather}
%
Under the condition $K_\perp < (V'-V)$, the neutron cannot be transmitted, only reflected. However, the wavefunction of the \ucn undergoing reflection penetrates a small distance into the surface, where it may be lost via the interactions described in Sec.~\ref{sec:ucn_absorption}.
