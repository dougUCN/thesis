...
\begin{align}
    ...
    \frac{I}{I_0} &= e^{-\sigma \gls*{rho_N} x}
\end{align}
%
Where $I_0$ is the beam density intensity at the entrance of the material. Defining the mean free path inside the material as $\lambda=1/(\gls*{rho_N} \sigma)$ we get the Beer-Lambert law, which describes flux attenuation.
%
\begin{gather}
    I(x) = I_0 e^{-x/\lambda} \label{eq:beer_lambert_law}
\end{gather}
%
