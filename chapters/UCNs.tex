...
% Loss probability may be expressed by non-conservation of current density $\vv{j}$ \cite{golubUCN}
% %
% \begin{gather}
%     \frac{\partial \rho(\vv{r},t)}{\partial t} + \nabla \vv{j}(\vv{r}, t)=-\frac{2W}{\hbar}\rho(\vv{r}, t)
% \end{gather}

% This is an equivalent expression to attenuation via the Beer-Lambert law (Sec.~\ref{sec:beer_lambert_law}).
